...
def yolo_head(feats, anchors, num_classes):
    ...
    anchors_tensor = tf.reshape(tf.cast(tf.Variable(anchors), tf.float32), [1, 1, 1, num_anchors, 2])
...
def yolo_eval(yolo_outputs,
    ...
    # K.get_session().run(tf.variables_initializer([max_boxes_tensor])) # Not needed in eager execution
